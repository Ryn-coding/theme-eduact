...
?>
                        ...
                        <div class="category-one__item">
                            <div class="category-one__wrapper" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/shapes/category-shape.png);">
                                ...
                                <div class="category-one__content">
                                    <div class="category-one__icon">
                                        <span class="<?php the_sub_field('category_icon'); ?>"></span>
                                    </div><!-- /.category-icon -->
                            ...
                            <div class="category-one__hover">
                                ...
                                <div class="category-one__hover__content">
                                    ...
                                    <h3 class="category-one__hover__title"><a href="<?php the_sub_field('category_url'); ?>"><?php the_sub_field('category_title'); ?></a></h3><!-- /.category-title -->
        ...
        <!-- Category End -->
        <!-- Course Start -->
        <?php $course_one_item = get_field('course_one_item'); ?>
                        ...
                        <div class="course-one__item">
                            ...
                            <div class="course-one__content">
                                ...
                                <h3 class="course-one__title">
                                    <a href="management-consulting.html"><?php the_sub_field('course_title'); ?></a>
                                </h3>
                                <div class="course-one__bottom">
                                    <div class="course-one__author">
                                        <img src="<?php the_sub_field('course_author_thumb'); ?>" alt="eduact">
                                        <h5 class="course-one__author__name"><?php the_sub_field('course_author_name'); ?></h5>
                                        <p class="course-one__author__designation"><?php the_sub_field('course_author_role'); ?></p>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="200ms">
                        <div class="counter-one__left">
                            <h4 class="counter-one__left__title"><?php echo get_field('counter_one_title'); ?></h4>
                            <div class="counter-one__left__content">
                                <?php echo get_field('counter_one_text'); ?>
                            </div>
                            <a href="<?php echo get_field('counter_join_now_url'); ?>" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span><?php echo get_field('counter_join_now_text'); ?><i class="icon-arrow"></i></a>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="counter-one__area wow zoomIn" data-wow-delay="400ms">
                            <h5 class="counter-one__title"><?php echo get_field('counter_desc'); ?></span></h5>
        ...
        <section class="testimonial-one">
            <div class="container">
                <div class="section-title text-center">
                    <h5 class="section-title__tagline">
                        <?php echo get_field('testimonial_one_tagline'); ?>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 133 13" fill="none">
                            <path d="M9.76794 0.395L0.391789 9.72833C-0.130596 10.2483 -0.130596 11.095 0.391789 11.615C0.914174 12.135 1.76472 12.135 2.28711 11.615L11.6633 2.28167C12.1856 1.76167 12.1856 0.915 11.6633 0.395C11.1342 -0.131667 10.2903 -0.131667 9.76794 0.395Z" fill="#F1F2FD" />
                            <path d="M23.1625 0.395L13.7863 9.72833C13.2639 10.2483 13.2639 11.095 13.7863 11.615C14.3087 12.135 15.1593 12.135 15.6816 11.615L25.0578 2.28167C25.5802 1.76167 25.5802 0.915 25.0578 0.395C24.5287 -0.131667 23.6849 -0.131667 23.1625 0.395Z" fill="#F1F2FD" />
                            <path d="M36.5569 0.395L27.1807 9.72833C26.6583 10.2483 26.6583 11.095 27.1807 11.615C27.7031 12.135 28.5537 12.135 29.076 11.615L38.4522 2.28167C38.9746 1.76167 38.9746 0.915 38.4522 0.395C37.9231 -0.131667 37.0793 -0.131667 36.5569 0.395Z" fill="#F1F2FD" />
                    ...
                    <h2 class="section-title__title"><?php echo get_field('testimonial_one_title'); ?></h2>
                </div><!-- section-title -->
                <?php $testimonial_one = get_field('testimonial_one'); ?>
                <div class="testimonial-one__area">
                    <div class="testimonial-one__carousel eduact-owl__carousel owl-with-shadow owl-theme owl-carousel" data-owl-options='{
                        ...
                        <!-- Testimonial Item -->
                            <?php if( have_rows('testimonial_one') ):
                                while( have_rows('testimonial_one') ) : the_row();
                            ?>
                        <div class="item">
                            <div class="testimonial-one__item">
                                <div class="testimonial-one__author">
                                    <img src="<?php the_sub_field('testimonial_thumb'); ?>" alt="eduact">
                                ...
                                <div class="testimonial-one__content">
                                    ...
                                    <div class="testimonial-one__meta">
                                        <h5 class="testimonial-one__title"><?php the_sub_field('testimonial_author_name'); ?></h5>
                                        <span class="testimonial-one__designation"><?php the_sub_field('testimonial_role'); ?></span>
                    ...
                    <div class="testimonial-one__thumb wow fadeInUp" data-wow-delay="200ms">
                        <img src="<?php echo get_field('testimonial_main_thumb'); ?>" alt="eduact">
        ...
        <!-- Testimonial End -->
        <!-- Team Start -->
        <?php $team_one = get_field('team_one'); ?>
        <section class="team-one" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/shapes/team-bg-1.png);">
            <div class="container">
                <div class="section-title text-center wow fadeInUp" data-wow-delay="100ms">
                    <h5 class="section-title__tagline">
                        <?php echo get_field('team_one_tagline'); ?>
                    ...
                    <h2 class="section-title__title"><?php echo get_field('team_one_title'); ?></h2>
                </div><!-- section-title -->
                <div class="row">
                    <?php if( have_rows('team_one') ):
                        while( have_rows('team_one') ) : the_row();
                    ?>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-one__item">
                            <div class="team-one__image">
                                <img src="<?php the_sub_field('team_one_img'); ?>" alt="eduact">
                            </div><!-- /.team-image -->
                            <div class="team-one__content">
                                <h3 class="team-one__title">
                                    <a href="team-details.html"><?php the_sub_field('team__author'); ?></a>
                                </h3><!-- /.team-name -->
                                <span class="team-one__designation"><?php the_sub_field('team__author_role'); ?></span><!-- /.team-designation -->
                                <div class="team-one__social">
                                    <a href="<?php the_sub_field('facebook_url'); ?>"><i class="fab fa-facebook-f"></i></a>
                                    <a href="<?php the_sub_field('youtube_url'); ?>"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="<?php the_sub_field('linkedin_url'); ?>"><i class="fab fa-youtube"></i></a>
                                </div><!-- /.team-social -->
                            </div><!-- /.team-content -->
                        </div><!-- /.team-one -->
                    </div>
        ...
        <section class="blog-one">
            <div class="container">
                <div class="section-title text-center">
                    <h5 class="section-title__tagline">
                        <?php echo get_field('blog_tagline'); ?>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 133 13" fill="none">
                            <path d="M9.76794 0.395L0.391789 9.72833C-0.130596 10.2483 -0.130596 11.095 0.391789 11.615C0.914174 12.135 1.76472 12.135 2.28711 11.615L11.6633 2.28167C12.1856 1.76167 12.1856 0.915 11.6633 0.395C11.1342 -0.131667 10.2903 -0.131667 9.76794 0.395Z" fill="#F1F2FD" />
                            <path d="M23.1625 0.395L13.7863 9.72833C13.2639 10.2483 13.2639 11.095 13.7863 11.615C14.3087 12.135 15.1593 12.135 15.6816 11.615L25.0578 2.28167C25.5802 1.76167 25.5802 0.915 25.0578 0.395C24.5287 -0.131667 23.6849 -0.131667 23.1625 0.395Z" fill="#F1F2FD" />
                            <path d="M36.5569 0.395L27.1807 9.72833C26.6583 10.2483 26.6583 11.095 27.1807 11.615C27.7031 12.135 28.5537 12.135 29.076 11.615L38.4522 2.28167C38.9746 1.76167 38.9746 0.915 38.4522 0.395C37.9231 -0.131667 37.0793 -0.131667 36.5569 0.395Z" fill="#F1F2FD" />
                    ...
                    <h2 class="section-title__title"><?php echo get_field('blog_text'); ?></h2>
                </div><!-- section-title -->
                <div class="row">
                    <div class="col-xl-8 wow fadeInUp" data-wow-delay="200ms">
                        <?php $team_one = get_field('blog_one'); ?>
                        <?php if( have_rows('blog_one') ):
                            while( have_rows('blog_one') ) : the_row();
                        ?>
                        <div class="blog-one__item">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="blog-one__image">
                                        <img src="<?php the_sub_field('blog_img'); ?>" alt="eduact">
                                        <a href="<?php the_sub_field('blog_url'); ?>"></a>
                                    </div><!-- /.blog-image -->
                                </div>
                                <div class="col-md-7 d-flex align-items-center">
                                    <div class="blog-one__content">
                                        <div class="blog-one__cats"><a href="<?php the_sub_field('blog_url'); ?>"><?php the_sub_field('blog_category'); ?></a></div>
                                        <h3 class="blog-one__title">
                                            <a href="<?php the_sub_field('blog_url'); ?>"><?php the_sub_field('blog_title'); ?></a>
                                        </h3><!-- /.blog-title -->
                                        <div class="blog-one__meta">
                                            <div class="blog-one__meta__author">
                                                <img src="<?php the_sub_field('blog_author'); ?>" alt="eduact" />
                                                <a href="<?php the_sub_field('blog_url'); ?>"><?php the_sub_field('blog_author_name'); ?></a>
                                                <?php the_sub_field('blog_author_name'); ?>
                                            </div>
                                            <div class="blog-one__meta__date"><?php the_sub_field('blog_date'); ?></div><!-- /.blog-date -->
                                        </div><!-- /.blog-meta -->
                                    </div><!-- /.blog-content -->
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 wow fadeInRight" data-wow-delay="200ms">
                        <div class="blog-one__cta" style="background-image: url(<?php echo get_field('newsletter_bg'); ?>);">
                            <div class="blog-one__cta__icon"><span class="<?php echo get_field('newsletter_icon'); ?>"></span></div>
                            <h3 class="blog-one__cta__title"><?php echo get_field('newsletter_title'); ?></h3>
                            <form class="blog-one__cta__email-box mc-form" data-url="MC_FORM_URL" novalidate="novalidate">
                                ...
                                <button type="submit" class="eduact-btn"><span class="eduact-btn__curve"></span><?php echo get_field('newsletter_btn_text'); ?></button>
                            </form>
                            <div class="mc-form__response"></div>
                            <p class="blog-one__cta__text"><?php echo get_field('newsletter_text'); ?></p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-7 wow fadeInLeft" data-wow-delay="200ms">
                        <div class="cta-one__left">
                            <img src="<?php echo get_field('left_img'); ?>" alt="eduact" />
                            <h3 class="cta-one__left__title"><?php echo get_field('left_text'); ?></h3>
                            <a href="<?php echo get_field('left_btn_url'); ?>" class="eduact-btn eduact-btn-second"><span class="eduact-btn__curve"></span><?php echo get_field('left_btn_text'); ?><i class="icon-arrow"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="cta-one__thumb__area wow fadeInUp" data-wow-delay="200ms">
                            <div class="cta-one__thumb eduact-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 4, "speed": 700, "scale": 1 }'>
                                <img src="<?php echo get_field('cta_thumb'); ?>" alt="eduact">
                            </div>
