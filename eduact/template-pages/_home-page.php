            ...
            "responsive":{
                ...
                "1400":{
                    ...
                    <div class="item">
                        <div class="category-one__item">
                            <div class="category-one__wrapper" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/shapes/category-shape.png);">
                                <div class="category-one__thumb"><img src="<?php echo get_template_directory_uri() ?>/assets/images/category/category-normal-1.png" alt="eduact" /></div><!-- /.category-thumb -->
                    ...
                    <div class="item">
                        <div class="category-one__item">
                            <div class="category-one__wrapper" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/shapes/category-shape.png);">
                                <div class="category-one__thumb"><img src="<?php echo get_template_directory_uri() ?>/assets/images/category/category-normal-2.png" alt="eduact" /></div><!-- /.category-thumb -->
                                <div class="category-one__content">
                                    <div class="category-one__icon">
                    ...
                    <div class="item">
                        <div class="category-one__item">
                            <div class="category-one__wrapper" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/shapes/category-shape.png);">
                                <div class="category-one__thumb"><img src="<?php echo get_template_directory_uri() ?>/assets/images/category/category-normal-3.png" alt="eduact" /></div><!-- /.category-thumb -->
                                <div class="category-one__content">
                                    <div class="category-one__icon">
                    ...
                    <div class="item">
                        <div class="category-one__item">
                            <div class="category-one__wrapper" style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/shapes/category-shape.png);">
                                <div class="category-one__thumb"><img src="<?php echo get_template_directory_uri() ?>/assets/images/category/category-normal-4.png" alt="eduact" /></div><!-- /.category-thumb -->
                                <div class="category-one__content">
                                    <div class="category-one__icon">
